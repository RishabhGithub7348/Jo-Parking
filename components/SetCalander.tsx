  ...
  return (
    <div
      className={`flex relative items-center justify-center rounded-md p-2 font-semibold cursor-pointer border-2 
        ...
        isCurrentDate ? ' border-2  rounded-md  bg-violet-200 text-blue-600 font-bold text-base' : ''
    ...
    >
      {isCurrentDate && (
        <div className="absolute bottom-0 mb-[3px] bg-violet-400 ml-4 left-0 -right-1 w-[6px] h-[6px] text-2xl bg-blue-700 rounded-full" />
      )}
      {day}
    </div>
  );
